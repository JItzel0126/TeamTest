 ...
 */
@Service
public class FileDbSeriveImpl implements FileDbService {
	@Autowired
...
//	다운로드 URL을 만들어주는 메소드
//	URL:웹브라우저주소창 또는 ing 태그 -> 해당하는 컨트롤러 메소드가 이미지를 전송해 줌
...
//		URL 만드는 클래스	  :ServletUriComponentsBuilder
		return ServletUriComponentsBuilder      
	          ...
	          .toUriString();				
//	위에꺼조합:http://localhost:8080/fileDb/download.do?uuid=uuid값
	   }
